# Systemmonitoring with Grafana, InfluxDB and Telegraf

![newdashboard](https://user-images.githubusercontent.com/51527551/78051488-0e3a5980-737e-11ea-9101-d7ee7b8ecac1.PNG)
...
## 2. Setup
### 2.1 InfluxDB
**2.1.1 Install the InfluxDB package for your system**
...
**2.1.2 Configure InfluxDB**

The config file is located at `/etc/influxdb/influxdb.conf`

Open the file and search for the `[http]`part of the file

Uncomment the `enable = true` and the `bind-address = :8086` in the config file.
...
Change into the database shell with by typing `influx`

Create a database for telegraf called `telegraf`
...
### 2.2 Telegraf
**2.2.1 Install Telegraf for your system**
Add the repository
```bash
sudo apt-get update && sudo apt-get install apt-transport-https
```

The Telegraf documentation recommends this, so that apt will be able to read the repository
...
**2.3.1 Install Grafana on you system**
...
![](https://user-images.githubusercontent.com/51527551/78049657-9834f300-737b-11ea-8565-9921fed6a0af.PNG)

For the network I use our configured `net` plugin from telegraf. Here is my queryconfiguration:

![](https://user-images.githubusercontent.com/51527551/78049672-9b2fe380-737b-11ea-8971-064e62b29f4e.PNG)
...
![](https://user-images.githubusercontent.com/51527551/78049670-99feb680-737b-11ea-97c3-85f38bf36e25.PNG)
...
![](https://user-images.githubusercontent.com/51527551/78049664-99662000-737b-11ea-80a6-3781e3a0f2c5.PNG)
...
***
And there we are, a finished dashboard. Now you can add some eyecandy and stuff like this.
